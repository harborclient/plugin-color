...
// node_modules/.pnpm/@harborclient+sdk@1.0.67_@babel+runtime@8.0.0_@codemirror+search@6.7.1_@codemirror+them_3c89fa62c09d96ae3e3b559a96baacfd/node_modules/@harborclient/sdk/dist/runtime/index.js
...
// node_modules/.pnpm/@harborclient+sdk@1.0.67_@babel+runtime@8.0.0_@codemirror+search@6.7.1_@codemirror+them_3c89fa62c09d96ae3e3b559a96baacfd/node_modules/@harborclient/sdk/dist/clipboard.js
...
var RECENT_STORAGE_KEY = "recent";
var MAX_RECENT = 8;
var DEFAULT_HEX = "#3C3C3C";
function isEyeDropperSupported() {
  return typeof window !== "undefined" && "EyeDropper" in window;
}
function ColorPanel({ hc }) {
  ...
  const displayName = customName.trim().length > 0 ? customName.trim() : formats?.name ?? "Not named";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full min-h-0 flex-col bg-control", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center justify-between gap-2 border-b border-separator px-3 py-2 pr-8", children: [
        ...
        /* @__PURE__ */ jsxs(
          "svg",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("path", { d: "m15 6 3-3 3 3-3 3z" }),
              /* @__PURE__ */ jsx("path", { d: "m14 7 3 3" })
            ]
          }
        ),
        /* @__PURE__ */ jsx("h3", { className: "m-0 text-[14px] font-medium text-text", children: "Eyedropper" })
      ] }),
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          children: picking ? "Picking\u2026" : "Pick color"
        }
      )
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "min-h-0 flex-1 overflow-auto px-3 py-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative flex gap-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-1 flex-col gap-2", children: [
          /* @__PURE__ */ jsxs("label", { className: "flex min-w-0 flex-col gap-1", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[14px] text-muted", children: "Name" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                value: customName,
          ...
          formats != null ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(
              ColorFormatRow,
              {
                label: "Color name",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 flex-col gap-2 pt-6", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
...
function activate(hc) {
  ...
  function ColorPanelHost() {
    return /* @__PURE__ */ jsx(ColorPanel, { hc });
  }
